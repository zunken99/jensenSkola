...
class Program
{
    static void Main()
    {
        ...
        PrivateCustomer isak = new PrivateCustomer("isak", "svensson", "19900101-1234", 123456789, "Malmögatan Malmö", "Malmögatan Ystad", "0701234567");
        OrganizationCustomer bosseBil = new OrganizationCustomer("Bosse bildoktor", "556677-8899", 987654321, "Storgatan Malmö", "Storgatan Ystad", "0709876543");
